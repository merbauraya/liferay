...
/*mazlan, added hook to allow min/max button for document & media portlet for authenticated user */
String Documents_and_Media_pID = "20";
if (themeDisplay.isSignedIn() && portletId.equalsIgnoreCase(Documents_and_Media_pID))
{
	showMaxIcon = true;
	showMinIcon = true;
}
