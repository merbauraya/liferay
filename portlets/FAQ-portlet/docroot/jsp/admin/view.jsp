...
listURL.setParameter("jspPage", "/jsp/admin/list.jsp");
PortletURL entryURL = renderResponse.createRenderURL();
entryURL.setParameter("jspPage", "/jsp/admin/entry.jsp");

PortletURL viewURL = renderResponse.createRenderURL();
viewURL.setParameter("jspPage", "/jsp/admin/viewfaq.jsp");
%>
...
<div class="lfr-search-container" style="margin-top:5px;">
	...
	<div class="results-grid searchcontainer-content">
