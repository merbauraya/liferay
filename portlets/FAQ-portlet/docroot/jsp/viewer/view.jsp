...
<%@include file="/jsp/viewer/init-ext.jsp" %>
<%
	
	List<FAQEntry> faqs	= null;
	if (Validator.isNotNull(selectedCategory)){
		faqs  = FAQEntryLocalServiceUtil.getByCategory(selectedCategory);	
		
		}
		else {
			faqs = FAQEntryLocalServiceUtil.getAll();
		}
...
<div class="faq-portlet-outer">
	<div class="faq-portlet-inner">
		...
		<%
				...
				out.println("</span>");
		%>
		<div class="faq-answer <%= (windowState.equals(WindowState.MAXIMIZED)) ? "" : "hide" %>">
