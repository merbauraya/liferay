...
public class FAQPortlet extends MVCPortlet {
    ...
    ActionResponse actionResponse)
		 ...
		 FAQEntryLocalServiceUtil.addEntry(category,question,answer,themeDisplay.getUserId(),
				themeDisplay.getCompanyId(),themeDisplay.getScopeGroupId(),user.getFullName());
