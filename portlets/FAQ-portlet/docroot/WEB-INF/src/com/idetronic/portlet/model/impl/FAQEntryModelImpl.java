...
public class FAQEntryModelImpl extends BaseModelImpl<FAQEntry>
	...
	public static final String TABLE_SQL_CREATE = "create table FAQ_FAQEntry (entryId LONG not null primary key,companyId LONG,groupId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,question VARCHAR(255) null,category VARCHAR(75) null,answer TEXT null,isactive BOOLEAN,displayOrder LONG)";
	public static final String TABLE_SQL_DROP = "drop table FAQ_FAQEntry";
	public static final String ORDER_BY_JPQL = " ORDER BY faqEntry.entryId ASC";
	public static final String ORDER_BY_SQL = " ORDER BY FAQ_FAQEntry.entryId ASC";
	...
	public Object clone() {
		...
		faqEntryImpl.setGroupId(getGroupId());
	...
	public CacheModel<FAQEntry> toCacheModel() {
		...
		faqEntryCacheModel.groupId = getGroupId();
