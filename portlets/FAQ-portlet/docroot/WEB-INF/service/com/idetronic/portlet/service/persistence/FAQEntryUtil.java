...
public class FAQEntryUtil {
	 ...
	 */
	public static FAQEntry update(FAQEntry faqEntry) throws SystemException {
		return getPersistence().update(faqEntry);
	}

	/**
	 * @see com.liferay.portal.service.persistence.BasePersistence#update(com.liferay.portal.model.BaseModel, ServiceContext)
	 */
	public static FAQEntry update(FAQEntry faqEntry,
		ServiceContext serviceContext) throws SystemException {
		return getPersistence().update(faqEntry, serviceContext);
	}
	...
	*/
	...
	public static com.idetronic.portlet.model.FAQEntry updateImpl(
		...
		return getPersistence().updateImpl(faqEntry);
	}
