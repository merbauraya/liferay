...
import com.idetronic.model.StaffModel;
...
/**
 * The base model implementation for the Staff service. Represents a row in the &quot;staff_active&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface {@link com.idetronic.model.StaffModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link StaffImpl}.
 * </p>
 *
 * @author Mazlan Mat
 * @see StaffImpl
 * @see com.idetronic.model.Staff
 * @see com.idetronic.model.StaffModel
 * @generated
 */
public class StaffModelImpl extends BaseModelImpl<Staff> implements StaffModel {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a Staff model instance should use the {@link com.idetronic.model.Staff} interface instead.
	 */
	public static final String TABLE_NAME = "staff_active";
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.entity.cache.enabled.com.idetronic.model.Staff"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.finder.cache.enabled.com.idetronic.model.Staff"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = false;
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
				"lock.expiration.time.com.idetronic.model.Staff"));
	...
	public Object clone() {
		...
		staffImpl.setBp_name(getBp_name());
		staffImpl.setBp_no_pekerja(getBp_no_pekerja());
		staffImpl.setBp_no_kp(getBp_no_kp());
		staffImpl.setBk_jab_hakiki(getBk_jab_hakiki());
		staffImpl.setBk_jab_hakiki_desc(getBk_jab_hakiki_desc());
		staffImpl.setBk_jab_sekarang(getBk_jab_sekarang());
		staffImpl.setBk_jab_sekarang_desc(getBk_jab_sekarang_desc());
		staffImpl.setBk_jaw_jenis(getBk_jaw_jenis());
		staffImpl.setAl_alamat1(getAl_alamat1());
		staffImpl.setAl_alamat2(getAl_alamat2());
		staffImpl.setAl_alamat3(getAl_alamat3());
		staffImpl.setAl_poskod(getAl_poskod());
		staffImpl.setAl_bandar(getAl_bandar());
		staffImpl.setAl_negeri(getAl_negeri());
		staffImpl.setAl_negara(getAl_negara());
		staffImpl.setBp_telefon(getBp_telefon());
		staffImpl.setBp_email(getBp_email());
		staffImpl.setBp_tjangka_bsara(getBp_tjangka_bsara());
		staffImpl.setBp_rekod_status(getBp_rekod_status());
		staffImpl.setBk_jaw_hakiki(getBk_jaw_hakiki());
		staffImpl.setBk_jaw_hakiki_desc(getBk_jaw_hakiki_desc());
		staffImpl.setBk_jaw_sekarang(getBk_jaw_sekarang());
		staffImpl.setBk_jaw_sekarang_desc(getBk_jaw_sekarang_desc());
		staffImpl.setBk_tarikh_lahir(getBk_tarikh_lahir());
		staffImpl.setBk_tarikh_masuk(getBk_tarikh_masuk());
		staffImpl.setBk_rekod_status(getBk_rekod_status());
	...
	public CacheModel<Staff> toCacheModel() {
		...
		staffCacheModel.bp_name = getBp_name();

		String bp_name = staffCacheModel.bp_name;

		if ((bp_name != null) && (bp_name.length() == 0)) {
			staffCacheModel.bp_name = null;
		}

		staffCacheModel.bp_no_pekerja = getBp_no_pekerja();

		String bp_no_pekerja = staffCacheModel.bp_no_pekerja;

		if ((bp_no_pekerja != null) && (bp_no_pekerja.length() == 0)) {
			staffCacheModel.bp_no_pekerja = null;
		}

		staffCacheModel.bp_no_kp = getBp_no_kp();

		String bp_no_kp = staffCacheModel.bp_no_kp;

		if ((bp_no_kp != null) && (bp_no_kp.length() == 0)) {
			staffCacheModel.bp_no_kp = null;
		}

		staffCacheModel.bk_jab_hakiki = getBk_jab_hakiki();

		String bk_jab_hakiki = staffCacheModel.bk_jab_hakiki;

		if ((bk_jab_hakiki != null) && (bk_jab_hakiki.length() == 0)) {
			staffCacheModel.bk_jab_hakiki = null;
		}

		staffCacheModel.bk_jab_hakiki_desc = getBk_jab_hakiki_desc();

		String bk_jab_hakiki_desc = staffCacheModel.bk_jab_hakiki_desc;

		if ((bk_jab_hakiki_desc != null) && (bk_jab_hakiki_desc.length() == 0)) {
			staffCacheModel.bk_jab_hakiki_desc = null;
		}

		staffCacheModel.bk_jab_sekarang = getBk_jab_sekarang();

		String bk_jab_sekarang = staffCacheModel.bk_jab_sekarang;

		if ((bk_jab_sekarang != null) && (bk_jab_sekarang.length() == 0)) {
			staffCacheModel.bk_jab_sekarang = null;
		}

		staffCacheModel.bk_jab_sekarang_desc = getBk_jab_sekarang_desc();

		String bk_jab_sekarang_desc = staffCacheModel.bk_jab_sekarang_desc;

		if ((bk_jab_sekarang_desc != null) &&
				(bk_jab_sekarang_desc.length() == 0)) {
			staffCacheModel.bk_jab_sekarang_desc = null;
		}

		staffCacheModel.bk_jaw_jenis = getBk_jaw_jenis();

		String bk_jaw_jenis = staffCacheModel.bk_jaw_jenis;

		if ((bk_jaw_jenis != null) && (bk_jaw_jenis.length() == 0)) {
			staffCacheModel.bk_jaw_jenis = null;
		}

		staffCacheModel.al_alamat1 = getAl_alamat1();

		String al_alamat1 = staffCacheModel.al_alamat1;

		if ((al_alamat1 != null) && (al_alamat1.length() == 0)) {
			staffCacheModel.al_alamat1 = null;
		}

		staffCacheModel.al_alamat2 = getAl_alamat2();

		String al_alamat2 = staffCacheModel.al_alamat2;

		if ((al_alamat2 != null) && (al_alamat2.length() == 0)) {
			staffCacheModel.al_alamat2 = null;
		}

		staffCacheModel.al_alamat3 = getAl_alamat3();

		String al_alamat3 = staffCacheModel.al_alamat3;

		if ((al_alamat3 != null) && (al_alamat3.length() == 0)) {
			staffCacheModel.al_alamat3 = null;
		}

		staffCacheModel.al_poskod = getAl_poskod();

		String al_poskod = staffCacheModel.al_poskod;

		if ((al_poskod != null) && (al_poskod.length() == 0)) {
			staffCacheModel.al_poskod = null;
		}

		staffCacheModel.al_bandar = getAl_bandar();

		String al_bandar = staffCacheModel.al_bandar;

		if ((al_bandar != null) && (al_bandar.length() == 0)) {
			staffCacheModel.al_bandar = null;
		}

		staffCacheModel.al_negeri = getAl_negeri();

		String al_negeri = staffCacheModel.al_negeri;

		if ((al_negeri != null) && (al_negeri.length() == 0)) {
			staffCacheModel.al_negeri = null;
		}

		staffCacheModel.al_negara = getAl_negara();

		String al_negara = staffCacheModel.al_negara;

		if ((al_negara != null) && (al_negara.length() == 0)) {
			staffCacheModel.al_negara = null;
		}

		staffCacheModel.bp_telefon = getBp_telefon();

		String bp_telefon = staffCacheModel.bp_telefon;

		if ((bp_telefon != null) && (bp_telefon.length() == 0)) {
			staffCacheModel.bp_telefon = null;
		}

		staffCacheModel.bp_email = getBp_email();

		String bp_email = staffCacheModel.bp_email;

		if ((bp_email != null) && (bp_email.length() == 0)) {
			staffCacheModel.bp_email = null;
		}

		Date bp_tjangka_bsara = getBp_tjangka_bsara();

		if (bp_tjangka_bsara != null) {
			staffCacheModel.bp_tjangka_bsara = bp_tjangka_bsara.getTime();
		}
		else {
			staffCacheModel.bp_tjangka_bsara = Long.MIN_VALUE;
		}

		staffCacheModel.bp_rekod_status = getBp_rekod_status();

		String bp_rekod_status = staffCacheModel.bp_rekod_status;

		if ((bp_rekod_status != null) && (bp_rekod_status.length() == 0)) {
			staffCacheModel.bp_rekod_status = null;
		}

		staffCacheModel.bk_jaw_hakiki = getBk_jaw_hakiki();

		String bk_jaw_hakiki = staffCacheModel.bk_jaw_hakiki;

		if ((bk_jaw_hakiki != null) && (bk_jaw_hakiki.length() == 0)) {
			staffCacheModel.bk_jaw_hakiki = null;
		}

		staffCacheModel.bk_jaw_hakiki_desc = getBk_jaw_hakiki_desc();

		String bk_jaw_hakiki_desc = staffCacheModel.bk_jaw_hakiki_desc;

		if ((bk_jaw_hakiki_desc != null) && (bk_jaw_hakiki_desc.length() == 0)) {
			staffCacheModel.bk_jaw_hakiki_desc = null;
		}

		staffCacheModel.bk_jaw_sekarang = getBk_jaw_sekarang();

		String bk_jaw_sekarang = staffCacheModel.bk_jaw_sekarang;

		if ((bk_jaw_sekarang != null) && (bk_jaw_sekarang.length() == 0)) {
			staffCacheModel.bk_jaw_sekarang = null;
		}

		staffCacheModel.bk_jaw_sekarang_desc = getBk_jaw_sekarang_desc();

		String bk_jaw_sekarang_desc = staffCacheModel.bk_jaw_sekarang_desc;

		if ((bk_jaw_sekarang_desc != null) &&
				(bk_jaw_sekarang_desc.length() == 0)) {
			staffCacheModel.bk_jaw_sekarang_desc = null;
		}

		Date bk_tarikh_lahir = getBk_tarikh_lahir();

		if (bk_tarikh_lahir != null) {
			staffCacheModel.bk_tarikh_lahir = bk_tarikh_lahir.getTime();
		}
		else {
			staffCacheModel.bk_tarikh_lahir = Long.MIN_VALUE;
		}

		Date bk_tarikh_masuk = getBk_tarikh_masuk();

		if (bk_tarikh_masuk != null) {
			staffCacheModel.bk_tarikh_masuk = bk_tarikh_masuk.getTime();
		}
		else {
			staffCacheModel.bk_tarikh_masuk = Long.MIN_VALUE;
		}

		staffCacheModel.bk_rekod_status = getBk_rekod_status();

		String bk_rekod_status = staffCacheModel.bk_rekod_status;

		if ((bk_rekod_status != null) && (bk_rekod_status.length() == 0)) {
			staffCacheModel.bk_rekod_status = null;
		}
