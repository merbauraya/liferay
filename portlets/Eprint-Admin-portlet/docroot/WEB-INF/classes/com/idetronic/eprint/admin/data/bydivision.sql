SELECT a.subjectid AS l1_subjectid, 
       ...
       0           AS l5_total, 
       0           AS l6_total 
FROM   eprint_divisions ep, 
       eprint, 
       subject_parents a, 
       subject_name_name b 
WHERE  ep.eprintid = eprint.eprintid 
       AND a.subjectid = 'divisions' 
       AND ep.divisions = a.subjectid 
...
WHERE  ep.eprintid = eprint.eprintid 
       AND l1.subjectid = 'divisions' 
       AND ep.divisions = l2.subjectid 
