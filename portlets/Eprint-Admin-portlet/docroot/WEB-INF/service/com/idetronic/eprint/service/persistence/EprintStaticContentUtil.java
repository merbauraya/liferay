...
public class EprintStaticContentUtil {
	...
	public static EprintStaticContent update(
		...
		throws SystemException {
		return getPersistence().update(eprintStaticContent, merge);
	}
	...
	public static EprintStaticContent update(
		...
		return getPersistence()
				   .update(eprintStaticContent, merge, serviceContext);
	}
	...
	*/
	...
	public static com.idetronic.eprint.model.EprintStaticContent updateImpl(
		...
		return getPersistence().updateImpl(eprintStaticContent, merge);
	}
