...
/**
 * The utility for the eprint static content local service. This utility wraps {@link com.idetronic.eprint.service.impl.EprintStaticContentLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
...
public class EprintStaticContentLocalServiceUtil {
	...
	*/
	public static com.idetronic.eprint.model.EprintStaticContent updateEprintStaticContent(
		...
		boolean merge)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateEprintStaticContent(eprintStaticContent, merge);
	}
