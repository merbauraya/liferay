...
/**
 * The base implementation of the eprint local service.
 *
 * <p>
...
public abstract class EprintLocalServiceBaseImpl extends BaseLocalServiceImpl
	...
	public Eprint addEprint(Eprint eprint) throws SystemException {
		...
		return eprintPersistence.update(eprint, false);
	}
	...
	public Eprint updateEprint(Eprint eprint) throws SystemException {
		return updateEprint(eprint, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Eprint updateEprint(Eprint eprint, boolean merge)
		throws SystemException {
		eprint.setNew(false);

		return eprintPersistence.update(eprint, merge);
	}
