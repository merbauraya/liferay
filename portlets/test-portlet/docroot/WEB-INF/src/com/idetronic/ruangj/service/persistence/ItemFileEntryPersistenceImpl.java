...
import com.idetronic.ruangj.NoSuchItemFileEntryException;
import com.idetronic.ruangj.model.ItemFileEntry;
import com.idetronic.ruangj.model.impl.ItemFileEntryImpl;
import com.idetronic.ruangj.model.impl.ItemFileEntryModelImpl;
...
public class ItemFileEntryPersistenceImpl extends BasePersistenceImpl<ItemFileEntry>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_ITEMID = new FinderPath(ItemFileEntryModelImpl.ENTITY_CACHE_ENABLED,
			ItemFileEntryModelImpl.FINDER_CACHE_ENABLED,
			ItemFileEntryImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByItemId",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_ITEMID =
		new FinderPath(ItemFileEntryModelImpl.ENTITY_CACHE_ENABLED,
			ItemFileEntryModelImpl.FINDER_CACHE_ENABLED,
			ItemFileEntryImpl.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"findByItemId", new String[] { Long.class.getName() },
			ItemFileEntryModelImpl.ITEMID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_ITEMID = new FinderPath(ItemFileEntryModelImpl.ENTITY_CACHE_ENABLED,
			ItemFileEntryModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<ItemFileEntry> findByItemId(long itemId)
	 ...
	 */
	@Override
	public List<ItemFileEntry> findByItemId(long itemId, int start, int end)
		throws SystemException {
	 ...
	 */
	@Override
	public ItemFileEntry findByItemId_First(long itemId,
		OrderByComparator orderByComparator)
		throws NoSuchItemFileEntryException, SystemException {
		ItemFileEntry itemFileEntry = fetchByItemId_First(itemId,
				orderByComparator);
	 ...
	 */
	@Override
	public ItemFileEntry fetchByItemId_First(long itemId,
		OrderByComparator orderByComparator) throws SystemException {
		List<ItemFileEntry> list = findByItemId(itemId, 0, 1, orderByComparator);
	 ...
	 */
	@Override
	public ItemFileEntry findByItemId_Last(long itemId,
		OrderByComparator orderByComparator)
		throws NoSuchItemFileEntryException, SystemException {
		ItemFileEntry itemFileEntry = fetchByItemId_Last(itemId,
				orderByComparator);
	 ...
	 */
	@Override
	public ItemFileEntry fetchByItemId_Last(long itemId,
		OrderByComparator orderByComparator) throws SystemException {
		...
		List<ItemFileEntry> list = findByItemId(itemId, count - 1, count,
				orderByComparator);
	 ...
	 */
	@Override
	public ItemFileEntry[] findByItemId_PrevAndNext(long itemEntryId,
		long itemId, OrderByComparator orderByComparator)
		throws NoSuchItemFileEntryException, SystemException {
		ItemFileEntry itemFileEntry = findByPrimaryKey(itemEntryId);
		...
		try {
			...
			array[0] = getByItemId_PrevAndNext(session, itemFileEntry, itemId,
					orderByComparator, true);

			array[1] = itemFileEntry;

			array[2] = getByItemId_PrevAndNext(session, itemFileEntry, itemId,
	...
	protected ItemFileEntry getByItemId_PrevAndNext(Session session,
	...
	public void removeByItemId(long itemId) throws SystemException {
		for (ItemFileEntry itemFileEntry : findByItemId(itemId,
	...
	private static final String _FINDER_COLUMN_ITEMID_ITEMID_2 = "itemFileEntry.itemId = ?";
	 ...
	 */
	@Override
	public ItemFileEntry create(long itemEntryId) {
		ItemFileEntry itemFileEntry = new ItemFileEntryImpl();

		itemFileEntry.setNew(true);
		itemFileEntry.setPrimaryKey(itemEntryId);
	 ...
	 */
	@Override
	public ItemFileEntry remove(long itemEntryId)
		throws NoSuchItemFileEntryException, SystemException {
		return remove((Serializable)itemEntryId);
	}
	...
	protected ItemFileEntry toUnwrappedModel(ItemFileEntry itemFileEntry) {
		...
		itemFileEntryImpl.setItemEntryId(itemFileEntry.getItemEntryId());
		itemFileEntryImpl.setItemId(itemFileEntry.getItemId());
		itemFileEntryImpl.setFileEntryId(itemFileEntry.getFileEntryId());
		itemFileEntryImpl.setFileType(itemFileEntry.getFileType());
		itemFileEntryImpl.setUserId(itemFileEntry.getUserId());
		itemFileEntryImpl.setUserName(itemFileEntry.getUserName());
		itemFileEntryImpl.setCreateDate(itemFileEntry.getCreateDate());
		itemFileEntryImpl.setModifiedDate(itemFileEntry.getModifiedDate());
	 ...
	 */
	@Override
	public ItemFileEntry findByPrimaryKey(long itemEntryId)
		throws NoSuchItemFileEntryException, SystemException {
		return findByPrimaryKey((Serializable)itemEntryId);
	}
	 ...
	 */
	@Override
	public ItemFileEntry fetchByPrimaryKey(long itemEntryId)
		throws SystemException {
		return fetchByPrimaryKey((Serializable)itemEntryId);
	}
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.idetronic.ruangj.model.ItemFileEntry")));
