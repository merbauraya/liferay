...
import com.idetronic.ruangj.NoSuchItemException;
import com.idetronic.ruangj.model.Item;
import com.idetronic.ruangj.model.impl.ItemImpl;
import com.idetronic.ruangj.model.impl.ItemModelImpl;
...
public class ItemPersistenceImpl extends BasePersistenceImpl<Item>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_ITEMTYPE = new FinderPath(ItemModelImpl.ENTITY_CACHE_ENABLED,
			ItemModelImpl.FINDER_CACHE_ENABLED, ItemImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_ITEMTYPE =
		new FinderPath(ItemModelImpl.ENTITY_CACHE_ENABLED,
			...
			ItemModelImpl.ITEMTYPE_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_ITEMTYPE = new FinderPath(ItemModelImpl.ENTITY_CACHE_ENABLED,
			ItemModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<Item> findByItemType(int itemType) throws SystemException {
	 ...
	 */
	@Override
	public List<Item> findByItemType(int itemType, int start, int end)
	 ...
	 */
	@Override
	public Item findByItemType_First(int itemType,
		OrderByComparator orderByComparator)
		throws NoSuchItemException, SystemException {
		Item item = fetchByItemType_First(itemType, orderByComparator);
	 ...
	 */
	@Override
	public Item fetchByItemType_First(int itemType,
		OrderByComparator orderByComparator) throws SystemException {
		List<Item> list = findByItemType(itemType, 0, 1, orderByComparator);
	 ...
	 */
	@Override
	public Item findByItemType_Last(int itemType,
		OrderByComparator orderByComparator)
		throws NoSuchItemException, SystemException {
		Item item = fetchByItemType_Last(itemType, orderByComparator);
	 ...
	 */
	@Override
	public Item fetchByItemType_Last(int itemType,
		OrderByComparator orderByComparator) throws SystemException {
		...
		List<Item> list = findByItemType(itemType, count - 1, count,
				orderByComparator);
	 ...
	 */
	@Override
	public Item[] findByItemType_PrevAndNext(long itemId, int itemType,
		OrderByComparator orderByComparator)
		throws NoSuchItemException, SystemException {
		...
		try {
			...
			array[0] = getByItemType_PrevAndNext(session, item, itemType,
					orderByComparator, true);

			array[1] = item;

			array[2] = getByItemType_PrevAndNext(session, item, itemType,
	...
	protected Item getByItemType_PrevAndNext(Session session, Item item,
		int itemType, OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByItemType(int itemType) throws SystemException {
		for (Item item : findByItemType(itemType, QueryUtil.ALL_POS,
	...
	private static final String _FINDER_COLUMN_ITEMTYPE_ITEMTYPE_2 = "item.itemType = ?";
	...
	@Override
	public Item updateImpl(com.idetronic.ruangj.model.Item item)
		throws SystemException {
		item = toUnwrappedModel(item);
		...
		if (isNew || !ItemModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((itemModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] { itemModelImpl.getOriginalItemType() };
				...
				args = new Object[] { itemModelImpl.getItemType() };
	...
	protected Item toUnwrappedModel(Item item) {
		...
		itemImpl.setItemType(item.getItemType());
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.idetronic.ruangj.model.Item")));
