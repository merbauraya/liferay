...
public class EprintSubjectPersistenceImpl extends BasePersistenceImpl<EprintSubject>
	 ...
	 */
	public EprintSubject create(long eprintId) {
		EprintSubject eprintSubject = new EprintSubjectImpl();

		eprintSubject.setNew(true);
		eprintSubject.setPrimaryKey(eprintId);
	 ...
	 */
	public EprintSubject remove(long eprintId)
	...
	protected EprintSubject toUnwrappedModel(EprintSubject eprintSubject) {
		...
		eprintSubjectImpl.setPos(eprintSubject.getPos());
		eprintSubjectImpl.setSubjects(eprintSubject.getSubjects());
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public EprintSubject findByPrimaryKey(long eprintId)
		throws NoSuchEprintSubjectException, SystemException {
		EprintSubject eprintSubject = fetchByPrimaryKey(eprintId);
		...
		if (eprintSubject == null) {
			...
			try {
				...
				if (eprintSubject != null) {
					...
					EntityCacheUtil.putResult(EprintSubjectModelImpl.ENTITY_CACHE_ENABLED,
						EprintSubjectImpl.class, eprintId, _nullEprintSubject);
				}
