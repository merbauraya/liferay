...
page import="com.idetronic.portlet.model.UserEntries_ExpertiseTags " %><%@
page import="com.idetronic.portlet.model.ExpertiseTag" %><%@
page import="com.idetronic.portlet.service.UserEntries_ExpertiseTagsLocalServiceUtil" %><%@
page import="com.idetronic.portlet.service.ExpertiseTagLocalServiceUtil" %><%@
page import="com.idetronic.portlet.service.ServiceExperienceLocalServiceUtil" %><%@
page import="com.idetronic.portlet.model.ServiceExperience" %><%@ 
...
<%@ page import="com.idetronic.portlet.util.Constant" %>
