 ...
 * @generated
 */
public abstract class UserExpertiseActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public UserExpertiseActionableDynamicQuery() throws SystemException {
		setBaseLocalService(UserExpertiseLocalServiceUtil.getService());
		setClass(UserExpertise.class);

		setClassLoader(com.idetronic.portlet.serviceexperience.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("userExpertiseId");
	}
}