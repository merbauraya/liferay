...
/**
 * Provides the local service interface for ServiceExperience. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Mazlan Mat
 * @see ServiceExperienceLocalServiceUtil
...
public interface ServiceExperienceLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ServiceExperienceLocalServiceUtil} to access the service experience local service. Add custom service methods to {@link com.idetronic.portlet.service.impl.ServiceExperienceLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
