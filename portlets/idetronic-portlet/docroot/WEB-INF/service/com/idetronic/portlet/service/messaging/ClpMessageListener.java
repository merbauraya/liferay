...
package com.idetronic.portlet.service.messaging;
...
public class ClpMessageListener extends BaseMessageListener {
	...
	protected void doReceive(Message message) throws Exception {
		...
		if (command.equals("undeploy") &&
			...
			ExpertiseTagLocalServiceUtil.clearService();

			OrgChartLocalServiceUtil.clearService();

			ServiceExperienceLocalServiceUtil.clearService();

			UserEntries_ExpertiseTagsLocalServiceUtil.clearService();
		}
	}
}