...
/**
 * Provides the local service interface for OrgChart. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Mazlan Mat
 * @see OrgChartLocalServiceUtil
...
public interface OrgChartLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link OrgChartLocalServiceUtil} to access the org chart local service. Add custom service methods to {@link com.idetronic.portlet.service.impl.OrgChartLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
