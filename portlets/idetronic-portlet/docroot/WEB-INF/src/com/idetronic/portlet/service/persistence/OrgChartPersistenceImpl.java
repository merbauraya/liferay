...
public class OrgChartPersistenceImpl extends BasePersistenceImpl<OrgChart>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_PARENTID = new FinderPath(OrgChartModelImpl.ENTITY_CACHE_ENABLED,
			OrgChartModelImpl.FINDER_CACHE_ENABLED, OrgChartImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_PARENTID =
		new FinderPath(OrgChartModelImpl.ENTITY_CACHE_ENABLED,
			...
			new String[] { Long.class.getName() },
			OrgChartModelImpl.PARENTID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_PARENTID = new FinderPath(OrgChartModelImpl.ENTITY_CACHE_ENABLED,
			OrgChartModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByparentId",
			new String[] { Long.class.getName() });

	/**
	 * Returns all the org charts where parentId = &#63;.
	 *
	 ...
	 */
	@Override
	public List<OrgChart> findByparentId(long parentId)
		throws SystemException {
	...
	/**
	 * Returns a range of all the org charts where parentId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.idetronic.portlet.model.impl.OrgChartModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	 ...
	 */
	@Override
	public List<OrgChart> findByparentId(long parentId, int start, int end)
		throws SystemException {
		return findByparentId(parentId, start, end, null);
	}

	/**
	 * Returns an ordered range of all the org charts where parentId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.idetronic.portlet.model.impl.OrgChartModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<OrgChart> findByparentId(long parentId, int start, int end,
		...
		if ((list != null) && !list.isEmpty()) {
			for (OrgChart orgChart : list) {
				if ((parentId != orgChart.getParentId())) {
					list = null;
	...
	/**
	 * Returns the first org chart in the ordered set where parentId = &#63;.
	 *
	 * @param parentId the parent ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the first matching org chart
	 ...
	 */
	@Override
	public OrgChart findByparentId_First(long parentId,
		OrderByComparator orderByComparator)
		throws NoSuchOrgChartException, SystemException {
		OrgChart orgChart = fetchByparentId_First(parentId, orderByComparator);
	 ...
	 */
	@Override
	public OrgChart fetchByparentId_First(long parentId,
		OrderByComparator orderByComparator) throws SystemException {
		List<OrgChart> list = findByparentId(parentId, 0, 1, orderByComparator);
	...
	/**
	 * Returns the last org chart in the ordered set where parentId = &#63;.
	 *
	 * @param parentId the parent ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the last matching org chart
	 ...
	 */
	@Override
	public OrgChart findByparentId_Last(long parentId,
		OrderByComparator orderByComparator)
		throws NoSuchOrgChartException, SystemException {
		OrgChart orgChart = fetchByparentId_Last(parentId, orderByComparator);
	 ...
	 */
	@Override
	public OrgChart fetchByparentId_Last(long parentId,
		OrderByComparator orderByComparator) throws SystemException {
		...
		List<OrgChart> list = findByparentId(parentId, count - 1, count,
				orderByComparator);
	...
	/**
	 * Returns the org charts before and after the current org chart in the ordered set where parentId = &#63;.
	 *
	 * @param orgChartPK the primary key of the current org chart
	 * @param parentId the parent ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public OrgChart[] findByparentId_PrevAndNext(OrgChartPK orgChartPK,
		...
		try {
			...
			array[0] = getByparentId_PrevAndNext(session, orgChart, parentId,
					orderByComparator, true);

			array[1] = orgChart;

			array[2] = getByparentId_PrevAndNext(session, orgChart, parentId,
					orderByComparator, false);
	...
	protected OrgChart getByparentId_PrevAndNext(Session session,
		OrgChart orgChart, long parentId, OrderByComparator orderByComparator,
		boolean previous) {
		StringBundler query = null;
	...
	/**
	 * Removes all the org charts where parentId = &#63; from the database.
	 *
	 * @param parentId the parent ID
	 * @throws SystemException if a system exception occurred
	 */
	...
	public void removeByparentId(long parentId) throws SystemException {
		for (OrgChart orgChart : findByparentId(parentId, QueryUtil.ALL_POS,
				QueryUtil.ALL_POS, null)) {
			remove(orgChart);
		}
	}
	...
	/**
	 * Returns the number of org charts where parentId = &#63;.
	 *
	 * @param parentId the parent ID
	 * @return the number of matching org charts
	 * @throws SystemException if a system exception occurred
	...
	private static final String _FINDER_COLUMN_PARENTID_PARENTID_2 = "orgChart.id.parentId = ?";
	...
	public OrgChart updateImpl(com.idetronic.portlet.model.OrgChart orgChart)
		...
		if (isNew || !OrgChartModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((orgChartModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						orgChartModelImpl.getOriginalParentId()
					};
				...
				args = new Object[] { orgChartModelImpl.getParentId() };
