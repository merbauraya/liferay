...
/**
 * Provides the local service utility for ItemAuthor. This utility wraps
 * {@link com.idetronic.subur.service.impl.ItemAuthorLocalServiceImpl} and is the
 ...
 * @see com.idetronic.subur.service.impl.ItemAuthorLocalServiceImpl
 * @generated
 */
public class ItemAuthorLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.idetronic.subur.service.impl.ItemAuthorLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.idetronic.subur.model.ItemAuthor addItemAuthor(
		com.idetronic.subur.model.ItemAuthor itemAuthor)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().addItemAuthor(itemAuthor);
	}
	...
	*/
	public static com.idetronic.subur.model.ItemAuthor createItemAuthor(
		com.idetronic.subur.service.persistence.ItemAuthorPK itemAuthorPK) {
		return getService().createItemAuthor(itemAuthorPK);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.idetronic.subur.model.ItemAuthor deleteItemAuthor(
		com.idetronic.subur.service.persistence.ItemAuthorPK itemAuthorPK)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteItemAuthor(itemAuthorPK);
	}
	...
	*/
	public static com.idetronic.subur.model.ItemAuthor deleteItemAuthor(
		com.idetronic.subur.model.ItemAuthor itemAuthor)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteItemAuthor(itemAuthor);
	}
	...
	*/
	...
	public static com.idetronic.subur.model.ItemAuthor fetchItemAuthor(
		com.idetronic.subur.service.persistence.ItemAuthorPK itemAuthorPK)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().fetchItemAuthor(itemAuthorPK);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.idetronic.subur.model.ItemAuthor getItemAuthor(
		com.idetronic.subur.service.persistence.ItemAuthorPK itemAuthorPK)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getItemAuthor(itemAuthorPK);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.idetronic.subur.model.ItemAuthor> getItemAuthors(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getItemAuthors(start, end);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static int getItemAuthorsCount()
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getItemAuthorsCount();
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.idetronic.subur.model.ItemAuthor updateItemAuthor(
		com.idetronic.subur.model.ItemAuthor itemAuthor)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateItemAuthor(itemAuthor);
	}
	...
	*/
	...
	public static void add(long itemId, long authorId)
		throws com.liferay.portal.kernel.exception.SystemException {
		getService().add(itemId, authorId);
	}
	...
	*/
	public static long[] getAuthorId(long itemId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getAuthorId(itemId);
	}
	...
	*/
	public static java.util.List<com.idetronic.subur.model.Author> getAuthors(
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getAuthors(itemId);
	}
	...
	* @throws SystemException
	*/
	public static com.idetronic.subur.model.Author[] getAuthorArray(long itemId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static ItemAuthorLocalService getService() {
		if (_service == null) {
			InvokableLocalService invokableLocalService = (InvokableLocalService)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					ItemAuthorLocalService.class.getName());

			if (invokableLocalService instanceof ItemAuthorLocalService) {
				_service = (ItemAuthorLocalService)invokableLocalService;
			}
			else {
				_service = new ItemAuthorLocalServiceClp(invokableLocalService);
			}

			ReferenceRegistry.registerReference(ItemAuthorLocalServiceUtil.class,
				"_service");
		}
	 ...
	 */
	public void setService(ItemAuthorLocalService service) {
	}

	private static ItemAuthorLocalService _service;
}