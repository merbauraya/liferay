 ...
 * @author Mazlan Mat
 */
public class DownloadSummaryClp extends BaseModelImpl<DownloadSummary>
	implements DownloadSummary {
	public DownloadSummaryClp() {
	}
	...
	public void setId(long id) {
		...
		if (_downloadSummaryRemoteModel != null) {
			try {
				Class<?> clazz = _downloadSummaryRemoteModel.getClass();

				Method method = clazz.getMethod("setId", long.class);

				method.invoke(_downloadSummaryRemoteModel, id);
			}
			catch (Exception e) {
	...
	public void setItemId(long itemId) {
		...
		if (_downloadSummaryRemoteModel != null) {
			try {
				...
				method.invoke(_downloadSummaryRemoteModel, itemId);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setPerMonth(int perMonth) {
		...
		if (_downloadSummaryRemoteModel != null) {
			try {
				...
				method.invoke(_downloadSummaryRemoteModel, perMonth);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setPerYear(int perYear) {
		...
		if (_downloadSummaryRemoteModel != null) {
			try {
				...
				method.invoke(_downloadSummaryRemoteModel, perYear);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setStatus(int status) {
		...
		if (_downloadSummaryRemoteModel != null) {
			try {
				...
				method.invoke(_downloadSummaryRemoteModel, status);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public BaseModel<?> getDownloadSummaryRemoteModel() {
		return _downloadSummaryRemoteModel;
	}

	public void setDownloadSummaryRemoteModel(
		BaseModel<?> downloadSummaryRemoteModel) {
		_downloadSummaryRemoteModel = downloadSummaryRemoteModel;
	}
	...
	public Object invokeOnRemoteModel(String methodName,
		...
		Class<?> remoteModelClass = _downloadSummaryRemoteModel.getClass();
		...
		Object returnValue = method.invoke(_downloadSummaryRemoteModel,
	...
	public DownloadSummary toEscapedModel() {
		return (DownloadSummary)ProxyUtil.newProxyInstance(DownloadSummary.class.getClassLoader(),
			new Class[] { DownloadSummary.class },
			new AutoEscapeBeanHandler(this));
	}

	@Override
	public Object clone() {
		DownloadSummaryClp clone = new DownloadSummaryClp();
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof DownloadSummaryClp)) {
			return false;
		}

		DownloadSummaryClp downloadSummary = (DownloadSummaryClp)obj;
	...
	private int _status;
	private BaseModel<?> _downloadSummaryRemoteModel;
