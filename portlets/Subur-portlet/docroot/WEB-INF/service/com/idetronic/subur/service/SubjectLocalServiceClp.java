 ...
 * @generated
 */
public class SubjectLocalServiceClp implements SubjectLocalService {
	public SubjectLocalServiceClp(InvokableLocalService invokableLocalService) {
		_invokableLocalService = invokableLocalService;

		_methodName0 = "addSubject";

		_methodParameterTypes0 = new String[] {
				"com.idetronic.subur.model.Subject"
			};
	...
	public com.idetronic.subur.model.Subject addSubject(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(subject) });
		}
		catch (Throwable t) {
		...
		return (com.idetronic.subur.model.Subject)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<com.idetronic.subur.model.Subject> getSubjects(
		...
		return (java.util.List<com.idetronic.subur.model.Subject>)ClpSerializer.translateOutput(returnObj);
	}
	...
	public int getItemCount(long subjectId)
		...
		try {
			...
			if (t instanceof com.idetronic.subur.NoSuchSubjectException) {
				throw (com.idetronic.subur.NoSuchSubjectException)t;
			}
