...
import com.idetronic.subur.service.DownloadSummaryLocalService;
...
/**
 * Provides the base implementation for the download summary local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.idetronic.subur.service.impl.DownloadSummaryLocalServiceImpl}.
 * </p>
 *
 * @author Mazlan Mat
 ...
 * @generated
 */
public abstract class DownloadSummaryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements DownloadSummaryLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.idetronic.subur.service.DownloadSummaryLocalServiceUtil} to access the download summary local service.
	 */
	...
	@Override
	public DownloadSummary addDownloadSummary(DownloadSummary downloadSummary)
		throws SystemException {
		downloadSummary.setNew(true);

		return downloadSummaryPersistence.update(downloadSummary);
	}
	 ...
	 */
	@Override
	public DownloadSummary createDownloadSummary(long id) {
		return downloadSummaryPersistence.create(id);
	}
	...
	@Override
	public DownloadSummary deleteDownloadSummary(long id)
		throws PortalException, SystemException {
		return downloadSummaryPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public DownloadSummary deleteDownloadSummary(
		DownloadSummary downloadSummary) throws SystemException {
		return downloadSummaryPersistence.remove(downloadSummary);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(DownloadSummary.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return downloadSummaryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return downloadSummaryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public DownloadSummary fetchDownloadSummary(long id)
		throws SystemException {
		return downloadSummaryPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public DownloadSummary getDownloadSummary(long id)
		throws PortalException, SystemException {
		return downloadSummaryPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return downloadSummaryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<DownloadSummary> getDownloadSummaries(int start, int end)
		throws SystemException {
		return downloadSummaryPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getDownloadSummariesCount() throws SystemException {
		return downloadSummaryPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public DownloadSummary updateDownloadSummary(
		DownloadSummary downloadSummary) throws SystemException {
		return downloadSummaryPersistence.update(downloadSummary);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.idetronic.subur.model.DownloadSummary",
			downloadSummaryLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = downloadSummaryPersistence.getDataSource();
	...
	private DownloadSummaryLocalServiceClpInvoker _clpInvoker = new DownloadSummaryLocalServiceClpInvoker();
}