...
import com.idetronic.subur.service.FileEntryTypeLocalService;
...
/**
 * Provides the base implementation for the file entry type local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.idetronic.subur.service.impl.FileEntryTypeLocalServiceImpl}.
 * </p>
 *
 * @author Mazlan Mat
 ...
 * @generated
 */
public abstract class FileEntryTypeLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements FileEntryTypeLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.idetronic.subur.service.FileEntryTypeLocalServiceUtil} to access the file entry type local service.
	 */
	...
	@Override
	public FileEntryType addFileEntryType(FileEntryType fileEntryType)
		throws SystemException {
		fileEntryType.setNew(true);

		return fileEntryTypePersistence.update(fileEntryType);
	}
	 ...
	 */
	@Override
	public FileEntryType createFileEntryType(long typeId) {
		return fileEntryTypePersistence.create(typeId);
	}
	...
	@Override
	public FileEntryType deleteFileEntryType(long typeId)
		throws PortalException, SystemException {
		return fileEntryTypePersistence.remove(typeId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public FileEntryType deleteFileEntryType(FileEntryType fileEntryType)
		throws SystemException {
		return fileEntryTypePersistence.remove(fileEntryType);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(FileEntryType.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return fileEntryTypePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return fileEntryTypePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public FileEntryType fetchFileEntryType(long typeId)
		throws SystemException {
		return fileEntryTypePersistence.fetchByPrimaryKey(typeId);
	}
	 ...
	 */
	@Override
	public FileEntryType getFileEntryType(long typeId)
		throws PortalException, SystemException {
		return fileEntryTypePersistence.findByPrimaryKey(typeId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return fileEntryTypePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<FileEntryType> getFileEntryTypes(int start, int end)
		throws SystemException {
		return fileEntryTypePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getFileEntryTypesCount() throws SystemException {
		return fileEntryTypePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public FileEntryType updateFileEntryType(FileEntryType fileEntryType)
		throws SystemException {
		return fileEntryTypePersistence.update(fileEntryType);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.idetronic.subur.model.FileEntryType",
			fileEntryTypeLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = fileEntryTypePersistence.getDataSource();
	...
	private FileEntryTypeLocalServiceClpInvoker _clpInvoker = new FileEntryTypeLocalServiceClpInvoker();
}