...
import com.idetronic.subur.service.StatViewTagLocalService;
...
/**
 * Provides the base implementation for the stat view tag local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.idetronic.subur.service.impl.StatViewTagLocalServiceImpl}.
 * </p>
 *
 * @author Mazlan Mat
 ...
 * @generated
 */
public abstract class StatViewTagLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements StatViewTagLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.idetronic.subur.service.StatViewTagLocalServiceUtil} to access the stat view tag local service.
	 */
	...
	@Override
	public StatViewTag addStatViewTag(StatViewTag statViewTag)
		throws SystemException {
		statViewTag.setNew(true);

		return statViewTagPersistence.update(statViewTag);
	}
	 ...
	 */
	@Override
	public StatViewTag createStatViewTag(long id) {
		return statViewTagPersistence.create(id);
	}
	...
	@Override
	public StatViewTag deleteStatViewTag(long id)
		throws PortalException, SystemException {
		return statViewTagPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public StatViewTag deleteStatViewTag(StatViewTag statViewTag)
		throws SystemException {
		return statViewTagPersistence.remove(statViewTag);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(StatViewTag.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return statViewTagPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return statViewTagPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return statViewTagPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public StatViewTag fetchStatViewTag(long id) throws SystemException {
		return statViewTagPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public StatViewTag getStatViewTag(long id)
		throws PortalException, SystemException {
		return statViewTagPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return statViewTagPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<StatViewTag> getStatViewTags(int start, int end)
		throws SystemException {
		return statViewTagPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getStatViewTagsCount() throws SystemException {
		return statViewTagPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public StatViewTag updateStatViewTag(StatViewTag statViewTag)
		throws SystemException {
		return statViewTagPersistence.update(statViewTag);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.idetronic.subur.model.StatViewTag",
			statViewTagLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = statViewTagPersistence.getDataSource();
	...
	private StatViewTagLocalServiceClpInvoker _clpInvoker = new StatViewTagLocalServiceClpInvoker();
}