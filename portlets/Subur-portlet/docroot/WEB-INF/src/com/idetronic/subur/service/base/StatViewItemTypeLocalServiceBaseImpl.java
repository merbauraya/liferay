...
import com.idetronic.subur.service.StatViewItemTypeLocalService;
...
/**
 * Provides the base implementation for the stat view item type local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.idetronic.subur.service.impl.StatViewItemTypeLocalServiceImpl}.
 * </p>
 *
 * @author Mazlan Mat
 ...
 * @generated
 */
public abstract class StatViewItemTypeLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements StatViewItemTypeLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.idetronic.subur.service.StatViewItemTypeLocalServiceUtil} to access the stat view item type local service.
	 */
	...
	@Override
	public StatViewItemType addStatViewItemType(
		StatViewItemType statViewItemType) throws SystemException {
		statViewItemType.setNew(true);

		return statViewItemTypePersistence.update(statViewItemType);
	}
	 ...
	 */
	@Override
	public StatViewItemType createStatViewItemType(long id) {
		return statViewItemTypePersistence.create(id);
	}
	...
	@Override
	public StatViewItemType deleteStatViewItemType(long id)
		throws PortalException, SystemException {
		return statViewItemTypePersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public StatViewItemType deleteStatViewItemType(
		StatViewItemType statViewItemType) throws SystemException {
		return statViewItemTypePersistence.remove(statViewItemType);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(StatViewItemType.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return statViewItemTypePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return statViewItemTypePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public StatViewItemType fetchStatViewItemType(long id)
		throws SystemException {
		return statViewItemTypePersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public StatViewItemType getStatViewItemType(long id)
		throws PortalException, SystemException {
		return statViewItemTypePersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return statViewItemTypePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<StatViewItemType> getStatViewItemTypes(int start, int end)
		throws SystemException {
		return statViewItemTypePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getStatViewItemTypesCount() throws SystemException {
		return statViewItemTypePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public StatViewItemType updateStatViewItemType(
		StatViewItemType statViewItemType) throws SystemException {
		return statViewItemTypePersistence.update(statViewItemType);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.idetronic.subur.model.StatViewItemType",
			statViewItemTypeLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = statViewItemTypePersistence.getDataSource();
	...
	private StatViewItemTypeLocalServiceClpInvoker _clpInvoker = new StatViewItemTypeLocalServiceClpInvoker();
}