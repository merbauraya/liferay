...
import com.idetronic.subur.service.StatDownloadCategoryLocalService;
...
/**
 * Provides the base implementation for the stat download category local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.idetronic.subur.service.impl.StatDownloadCategoryLocalServiceImpl}.
 * </p>
 *
 * @author Mazlan Mat
 ...
 * @generated
 */
public abstract class StatDownloadCategoryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements StatDownloadCategoryLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.idetronic.subur.service.StatDownloadCategoryLocalServiceUtil} to access the stat download category local service.
	 */
	...
	@Override
	public StatDownloadCategory addStatDownloadCategory(
		StatDownloadCategory statDownloadCategory) throws SystemException {
		statDownloadCategory.setNew(true);

		return statDownloadCategoryPersistence.update(statDownloadCategory);
	}
	 ...
	 */
	@Override
	public StatDownloadCategory createStatDownloadCategory(long id) {
		return statDownloadCategoryPersistence.create(id);
	}
	...
	@Override
	public StatDownloadCategory deleteStatDownloadCategory(long id)
		throws PortalException, SystemException {
		return statDownloadCategoryPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public StatDownloadCategory deleteStatDownloadCategory(
		StatDownloadCategory statDownloadCategory) throws SystemException {
		return statDownloadCategoryPersistence.remove(statDownloadCategory);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(StatDownloadCategory.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return statDownloadCategoryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return statDownloadCategoryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public StatDownloadCategory fetchStatDownloadCategory(long id)
		throws SystemException {
		return statDownloadCategoryPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public StatDownloadCategory getStatDownloadCategory(long id)
		throws PortalException, SystemException {
		return statDownloadCategoryPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return statDownloadCategoryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<StatDownloadCategory> getStatDownloadCategories(int start,
		int end) throws SystemException {
		return statDownloadCategoryPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getStatDownloadCategoriesCount() throws SystemException {
		return statDownloadCategoryPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public StatDownloadCategory updateStatDownloadCategory(
		StatDownloadCategory statDownloadCategory) throws SystemException {
		return statDownloadCategoryPersistence.update(statDownloadCategory);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.idetronic.subur.model.StatDownloadCategory",
			statDownloadCategoryLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = statDownloadCategoryPersistence.getDataSource();
	...
	private StatDownloadCategoryLocalServiceClpInvoker _clpInvoker = new StatDownloadCategoryLocalServiceClpInvoker();
}