...
FileEntry fileEntry = (FileEntry)request.getAttribute (SuburConstant.DOCUMENT_LIBRARY_FILE_ENTRY);//(WebKeys.DOCUMENT_LIBRARY_FILE_ENTRY);
...
long folderId = SuburFolderUtil.getFolderId(req2, themeDisplay);
%>
					...
					new Liferay.Upload(
						{
							...
							tempRandomSuffix: '<%= SuburConstant.TEMP_RANDOM_SUFFIX %>',
										...
										success: function(event, id, obj) {
											...
											for (var i = 0; i < jsonArray.length; i++) {
												...
												if (item.added) {
													...
													var pos = originalFileName.indexOf('<%= SuburConstant.TEMP_RANDOM_SUFFIX %>');
