...
public class XslTransformer {
	...
	public static String transform(URL xmlUrl,String xsltSource,Hashtable<String,String> params) 
			throws TransformerConfigurationException, TransformerException
	{
		String xml=null;
		try {
			xml = HttpUtil.URLtoString(xmlUrl);
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
		String xsl = xsltSource;
