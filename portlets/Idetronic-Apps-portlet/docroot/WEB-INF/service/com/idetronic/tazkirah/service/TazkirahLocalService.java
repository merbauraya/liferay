...
/**
 * Provides the local service interface for Tazkirah. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Mazlan Mat
 * @see TazkirahLocalServiceUtil
...
public interface TazkirahLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TazkirahLocalServiceUtil} to access the tazkirah local service. Add custom service methods to {@link com.idetronic.tazkirah.service.impl.TazkirahLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
