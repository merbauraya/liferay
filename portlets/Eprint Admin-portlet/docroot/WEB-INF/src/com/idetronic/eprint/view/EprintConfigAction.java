package com.idetronic.eprint.view;
...
public class EprintConfigAction implements ConfigurationAction{
	...
	public String render(PortletConfig portletConfig, RenderRequest renderRequest,
		...
		EprintViewConfig config = readConfig((PortletRequest)renderRequest);
		renderRequest.setAttribute("eprintConfig", (Object)(config));   
		return "/html/view/config.jsp";
	}
	public static EprintViewConfig readConfig(PortletRequest portletRequest)
	{
		EprintViewConfig config = new EprintViewConfig();
