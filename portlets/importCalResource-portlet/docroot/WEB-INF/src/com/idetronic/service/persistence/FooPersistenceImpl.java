...
import com.idetronic.NoSuchFooException;

import com.idetronic.model.Foo;
import com.idetronic.model.impl.FooImpl;
import com.idetronic.model.impl.FooModelImpl;
...
public class FooPersistenceImpl extends BasePersistenceImpl<Foo>
	...
	@Override
	public Foo updateImpl(com.idetronic.model.Foo foo)
		throws SystemException {
		foo = toUnwrappedModel(foo);
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.idetronic.model.Foo")));
