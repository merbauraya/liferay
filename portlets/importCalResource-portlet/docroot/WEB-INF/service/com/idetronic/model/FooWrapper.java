...
public class FooWrapper implements Foo, ModelWrapper<Foo> {
	...
	*/
	...
	@Override
	public int compareTo(com.idetronic.model.Foo foo) {
	...
	@Override
	public com.liferay.portal.model.CacheModel<com.idetronic.model.Foo> toCacheModel() {
		return _foo.toCacheModel();
	}

	@Override
	public com.idetronic.model.Foo toEscapedModel() {
		return new FooWrapper(_foo.toEscapedModel());
	}

	@Override
	public com.idetronic.model.Foo toUnescapedModel() {
