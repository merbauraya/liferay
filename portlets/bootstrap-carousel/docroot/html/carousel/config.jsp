...
<form action="<%=configActionUrl.toString() %>" method="post" name="<portlet:namespace />configuration">
	<table border="0" style="text-align: center;" class="carouselTable">
		<tr>
			<td style="text-align: right;">
				<div class="portlet-form-field-label">
					<liferay-ui:message key="carousel.type" />
				</div>
			</td>
			<td style="text-align: left;">
				<label class="portlet-form-field-label"><liferay-ui:message key="image" /></label>
				<input type="radio" name="carouselType" value="IMAGE" ${carousel.carouselType == 'IMAGE' ? 'checked' : '' }>
				<label class="portlet-form-field-label"><liferay-ui:message key="web.content" /></label>
				<input type="radio" name="carouselType" value="WEBCONTENT" ${carousel.carouselType == 'WEBCONTENT' ? 'checked' : '' }>
			</td>
		</tr>
		<tr>
			<td style="text-align: right;">
